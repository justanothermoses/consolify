...
consoleOutput.innerHTML = '<div style="position: fixed; width: 50px; height: 30px; right: 10px;bottom: ' + consoleHeight + 'px;background-color: #fffd;z-index: 100000; border-radius: 10px 10px 0 0; transition: .3s linear;"><div style="position: absolute;z-index: 100000;width: 20px; height: 20px; border-left: 2px solid #000; border-bottom: 2px solid #000; margin-left: 15px; margin-top: 0px; transform: rotateZ(315deg);transition: .3s linear;"></div></div>'
